// Base64エンコードされた文字列をUint8Arrayにデコードする
...
// Raw PCMオーディオデータをAudioBufferにデコードする
...
export function createWavBlob(pcmData: Int16Array, sampleRate: number, numChannels: number): Blob {
  ...
  view.setUint32(28, sampleRate * numChannels * 2, true); // バイトレート
